// Macroquad/miniquad JS glue for WASM (copied from db_test-working.js)
// This file is auto-generated and adapted for macroquad compatibility.
// BEGIN MACROQUAD GLUE
var wasm = undefined;
...
let __js_next_id = __js_values.length;
function __js_add(val) {
    __js_values.push(val);
    return __js_values.length - 1;
}
function __js_get(idx) {
    return __js_values[idx];
}
function __js_drop(idx) {
    if (idx < 5) return;
    __js_values[idx] = undefined;
}
function __js_take(idx) {
    const val = __js_get(idx);
    __js_drop(idx);
    return val;
}
// ... (rest of db_test-working.js glue code goes here) ...
// END MACROQUAD GLUE
